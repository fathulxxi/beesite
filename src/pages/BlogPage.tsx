      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
          <div className="text-center mb-16 relative">
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#2A1D5C] to-[#9003fc] bg-clip-text text-transparent">
              Our Blog
            </h1>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Insights, tutorials, and industry updates from the Beesite team.
            </p>
